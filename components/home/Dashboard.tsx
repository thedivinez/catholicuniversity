...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col w-4/5 mt-10 pb-5">
            ...
            <div className='flex justify-between h-96 bg-indigo-700/30 rounded-b-2xl py-14 px-10'>
                ...
                <div className='flex flex-col items-center space-y-6'>
                    <span className='bg-yellow-500 px-2 rounded-full text-blue-900 font-semibold uppercase'>Attachment Progress</span>
